...
def build_data_freshness_status(
    *,
    ...
    affected_symbols = [
        ...
        if core_dates.get(symbol) is None
        or (latest_market_date and core_dates.get(symbol, date.min) < expected_latest)
        or intraday_unconfirmed
    ]
    ...
    return {
        "version": "data_freshness_gate_v2",
