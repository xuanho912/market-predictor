...
Generated at: `2026-09-25T06:12:27.705269+00:00`
...
- stock_confluence_score: `49.77` / `mixed`
...
- stock_confluence_score: `44.23` / `weak`
...
- strongest_alert: `Stock Failed Bounce Risk` / `NO_ALERT` / `27.12`
- historical_analog_support: `supportive` / samples `10`
- validation_status: `not_yet_validated`
...
- stock_confluence_score: `37.88` / `weak`
...
- strongest_alert: `Stock Failed Bounce Risk` / `NO_ALERT` / `33.07`
- historical_analog_support: `supportive` / samples `10`
- validation_status: `not_yet_validated`
