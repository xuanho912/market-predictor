...
Generated at: `2026-06-16T14:42:25.130690+00:00`
...
- strongest_alert: `Relative Weakness Alert` / `WATCH` / `47.66`
...
- nearest_support: `202.89`
- nearest_resistance: `219.57`
- bounce_target_zone: `{"conservative": 214.57, "base": 214.57, "extended": 238.95, "source": "scenario_path + atr + recent_resistance", "meaning": "概率反抽情景参考区间，不是目标价承诺。", "not_trading_instruction": true}`
- failed_bounce_warning_zone: `{"first_warning": 205.81, "critical_warning": 199.34, "source": "risk_path + atr + recent_support", "meaning": "跌入该区间说明失败反抽风险上升。", "not_trading_instruction": true}`
...
- risk: `stock_failed_bounce` / `27.1%`
- stock_confluence_score: `30.1` / `weak`
- stock_alpha_score_v1: `0` / `weak_or_no_alpha_edge`
- 20d_outperformance_probability: `30.9%`
- 60d_expected_return: `-1.7%`
- risk_reward_ratio: `0.47`
- strongest_alert: `Relative Weakness Alert` / `WATCH` / `55.5`
...
- nearest_support: `390.08`
- nearest_resistance: `426.00`
- bounce_target_zone: `{"conservative": 415.23, "base": 415.23, "extended": 459.97, "source": "scenario_path + atr + recent_resistance", "meaning": "概率反抽情景参考区间，不是目标价承诺。", "not_trading_instruction": true}`
- failed_bounce_warning_zone: `{"first_warning": 396.37, "critical_warning": 380.15, "source": "risk_path + atr + recent_support", "meaning": "跌入该区间说明失败反抽风险上升。", "not_trading_instruction": true}`
...
- stock_confluence_score: `22.15` / `weak`
- stock_alpha_score_v1: `0` / `weak_or_no_alpha_edge`
- 20d_outperformance_probability: `30.1%`
- 60d_expected_return: `-3.4%`
- risk_reward_ratio: `0.57`
- strongest_alert: `Relative Weakness Alert` / `HIGH_CONVICTION` / `75.89`
...
- failed_bounce_warning_zone: `{"first_warning": 9.57, "critical_warning": 8.89, "source": "risk_path + atr + recent_support", "meaning": "跌入该区间说明失败反抽风险上升。", "not_trading_instruction": true}`
...
- stock_confluence_score: `35.24` / `weak`
...
- nearest_support: `261.80`
- nearest_resistance: `282.53`
- bounce_target_zone: `{"conservative": 276.31, "base": 276.31, "extended": 318.74, "source": "scenario_path + atr + recent_resistance", "meaning": "概率反抽情景参考区间，不是目标价承诺。", "not_trading_instruction": true}`
- failed_bounce_warning_zone: `{"first_warning": 265.43, "critical_warning": 240.51, "source": "risk_path + atr + recent_support", "meaning": "跌入该区间说明失败反抽风险上升。", "not_trading_instruction": true}`
