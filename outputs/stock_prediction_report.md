...
Generated at: `2026-08-31T23:59:45.935798+00:00`
...
- stock_confluence_score: `51.89` / `mixed`
...
- primary: `stock_bounce` / `25.7%`
- secondary: `stock_sideways` / `20.2%`
- risk: `stock_downside_continuation` / `14.5%`
- stock_confluence_score: `52.56` / `mixed`
- stock_alpha_score_v1: `44.0` / `weak_or_no_alpha_edge`
- 20d_outperformance_probability: `54.9%`
- 60d_expected_return: `0.7%`
- risk_reward_ratio: `0.86`
- strongest_alert: `Stock Bounce Setup` / `NO_ALERT` / `25.53`
- historical_analog_support: `supportive` / samples `10`
- validation_status: `not_yet_validated`
...
- bounce_target_zone: `{"conservative": 280.11, "base": 284.59, "extended": 293.28, "source": "scenario_path + atr + recent_resistance", "meaning": "概率反抽情景参考区间，不是目标价承诺。", "not_trading_instruction": true}`
- failed_bounce_warning_zone: `{"first_warning": 271.0, "critical_warning": 260.67, "source": "risk_path + atr + recent_support", "meaning": "跌入该区间说明失败反抽风险上升。", "not_trading_instruction": true}`
