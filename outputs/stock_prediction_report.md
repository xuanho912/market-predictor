...
Generated at: `2026-09-16T23:48:59.278888+00:00`
...
- stock_confluence_score: `47.64` / `mixed`
...
- strongest_alert: `Stock Failed Bounce Risk` / `NO_ALERT` / `25.9`
...
- nearest_support: `346.85`
- nearest_resistance: `374.93`
- bounce_target_zone: `{"conservative": 366.5, "base": 366.5, "extended": 395.27, "source": "scenario_path + atr + recent_resistance", "meaning": "概率反抽情景参考区间，不是目标价承诺。", "not_trading_instruction": true}`
...
- stock_confluence_score: `36.73` / `weak`
...
- strongest_alert: `Stock Failed Bounce Risk` / `NO_ALERT` / `31.67`
...
- stock_confluence_score: `39.49` / `weak`
