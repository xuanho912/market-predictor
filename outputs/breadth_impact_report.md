...
Generated at: `2026-07-10T22:37:46.845358Z`
...
| QQQ | False | True | MODERATE_EDGE | MODERATE_EDGE | bounce_path | bounce_path | 0.1556 | 0 | -3 | QQQ breadth conflicts with bounce_path: conflict score 66%, internal resonance is surface_only. | QQQ index strength may be surface-only; failed-bounce risk should remain capped higher until participation broadens. |
| IWM | False | False | STRONG_EDGE | STRONG_EDGE | bounce_path | bounce_path | 0.0506 | 0 | 4 | IWM breadth is mixed for bounce_path: support score 54%, conflict score 35%, internal resonance is weak. | IWM breadth is useful context but not strong enough to validate the primary path by itself. |
