...
Generated at: `2026-07-14T05:58:14.039993Z`
...
| QQQ | False | True | MODERATE_EDGE | MODERATE_EDGE | bounce_path | bounce_path | 0.0956 | 0 | -4 | QQQ breadth conflicts with bounce_path: conflict score 66%, internal resonance is weak. | QQQ breadth conflict or failed-bounce risk is elevated; watch new lows, percent above 20/50d MA and sector participation. |
| IWM | False | False | MODERATE_EDGE | MODERATE_EDGE | bounce_path | bounce_path | 0.0671 | 0 | 4 | IWM breadth is mixed for bounce_path: support score 50%, conflict score 46%, internal resonance is weak. | IWM breadth is useful context but not strong enough to validate the primary path by itself. |
