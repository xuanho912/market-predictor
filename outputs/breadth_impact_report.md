...
Generated at: `2026-08-12T13:50:13.052670Z`
...
| IWM | False | False | STRONG_EDGE | STRONG_EDGE | bounce_path | bounce_path | 0.0631 | 0 | 4 | IWM breadth is mixed for bounce_path: support score 55%, conflict score 43%, internal resonance is weak. | IWM breadth is useful context but not strong enough to validate the primary path by itself. |
| DIA | True | False | STRONG_EDGE | STRONG_EDGE | bounce_path | bounce_path | 0.0281 | 0 | 7 | DIA breadth supports bounce_path: internal resonance is aligned, support score 98%, above 20d/50d MA 73%/70%. | DIA breadth improves confidence in the primary path, but forward validation is still required. |
