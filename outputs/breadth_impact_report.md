...
Generated at: `2026-07-08T00:11:09.360320Z`
...
| QQQ | True | False | STRONG_EDGE | STRONG_EDGE | bounce_path | bounce_path | 0.0473 | 0 | 8 | QQQ breadth supports bounce_path: internal resonance is mixed, support score 66%, above 20d/50d MA 53%/52%. | QQQ breadth improves confidence in the primary path, but forward validation is still required. |
...
| DIA | True | False | MODERATE_EDGE | MODERATE_EDGE | bounce_path | bounce_path | 0.0313 | 0 | 10 | DIA breadth supports bounce_path: internal resonance is aligned, support score 98%, above 20d/50d MA 63%/63%. | DIA breadth improves confidence in the primary path, but forward validation is still required. |
