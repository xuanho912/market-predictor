...
Generated at: `2026-08-18T02:32:11.169213Z`
...
|---|---:|---:|---|---|---|---|---:|---:|---:|---|---|
| SPY | True | False | MODERATE_EDGE | MODERATE_EDGE | bounce_path | bounce_path | 0.041 | 0 | 8 | SPY breadth supports bounce_path: internal resonance is mixed, support score 79%, above 20d/50d MA 66%/70%. | SPY breadth improves confidence in the primary path, but forward validation is still required. |
...
| IWM | True | False | MODERATE_EDGE | MODERATE_EDGE | bounce_path | bounce_path | 0.0574 | 0 | 5 | IWM breadth is mixed for bounce_path: support score 56%, conflict score 39%, internal resonance is weak. | IWM breadth is useful context but not strong enough to validate the primary path by itself. |
