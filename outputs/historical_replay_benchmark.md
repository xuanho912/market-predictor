...
Generated at: `2026-07-01T05:56:38.549981+00:00`
...
- secondary_mean_absolute_error: `0.015355`
- primary_error_advantage: `-0.001924`
...
- secondary_mean_absolute_error: `0.019504`
- primary_error_advantage: `-0.00236`
- close_call_sample_size: `20`
...
- secondary_mean_absolute_error: `0.027485`
- primary_error_advantage: `-0.001853`
- close_call_sample_size: `20`
- close_call_primary_closer_rate: `0.35`
...
- secondary_mean_absolute_error: `0.040375`
- primary_error_advantage: `-0.011518`
- close_call_sample_size: `20`
...
- secondary_mean_absolute_error: `0.074119`
- primary_error_advantage: `0.00056`
- close_call_sample_size: `20`
...
- 10d: sample `80`, direction_hit `0.5375`, path_mae `0.029666`, as_primary `20`, as_primary_hit `0.4`, avg `-0.000657`, median `-0.001449`
...
### MODERATE_EDGE
- sample_size: `60`
- 3d: sample `60`, primary_hit `0.3833`, primary_closer `0.3833`, primary_mae `0.01827`, avg `-0.001582`, median `-0.002593`
- 5d: sample `60`, primary_hit `0.3667`, primary_closer `0.3833`, primary_mae `0.022926`, avg `-0.005453`, median `-0.008169`
- 10d: sample `60`, primary_hit `0.4833`, primary_closer `0.45`, primary_mae `0.027895`, avg `0.001651`, median `-0.000741`
- 20d: sample `60`, primary_hit `0.7`, primary_closer `0.4167`, primary_mae `0.046132`, avg `0.02192`, median `0.028709`
- 60d: sample `60`, primary_hit `0.7333`, primary_closer `0.5333`, primary_mae `0.079568`, avg `0.052753`, median `0.066423`

### WEAK_EDGE
- sample_size: `20`
- 3d: sample `20`, primary_hit `0.6`, primary_closer `0.4`, primary_mae `0.014306`, avg `-0.003795`, median `-0.003287`
- 5d: sample `20`, primary_hit `0.55`, primary_closer `0.45`, primary_mae `0.018675`, avg `-0.005946`, median `-0.005426`
...
- 5d: `{'predictor': 'downside_continuation_predictor', 'sample_size': 20, 'primary_hit_rate': 0.55, 'primary_closer_than_secondary_rate': 0.45, 'primary_mean_absolute_error': 0.018675, 'selection_method': 'lowest primary path error, tie-broken by hit rate and primary-vs-secondary closeness'}`
- 10d: `{'predictor': 'trend_reversal_predictor', 'sample_size': 60, 'primary_hit_rate': 0.4833, 'primary_closer_than_secondary_rate': 0.45, 'primary_mean_absolute_error': 0.027895, 'selection_method': 'lowest primary path error, tie-broken by hit rate and primary-vs-secondary closeness'}`
- 20d: `{'predictor': 'trend_reversal_predictor', 'sample_size': 60, 'primary_hit_rate': 0.7, 'primary_closer_than_secondary_rate': 0.4167, 'primary_mean_absolute_error': 0.046132, 'selection_method': 'lowest primary path error, tie-broken by hit rate and primary-vs-secondary closeness'}`
...
- sample_size: `80`
- 3d: sample `80`, primary_hit `0.4375`, primary_closer `0.3875`, primary_mae `0.017279`, avg `-0.002135`, median `-0.002845`
- 5d: sample `80`, primary_hit `0.4125`, primary_closer `0.4`, primary_mae `0.021864`, avg `-0.005576`, median `-0.007293`
- 10d: sample `80`, primary_hit `0.5125`, primary_closer `0.4375`, primary_mae `0.029338`, avg `-0.000657`, median `-0.001449`
- 20d: sample `80`, primary_hit `0.6`, primary_closer `0.375`, primary_mae `0.051893`, avg `0.015555`, median `0.019104`
- 60d: sample `80`, primary_hit `0.675`, primary_closer `0.525`, primary_mae `0.073559`, avg `0.038839`, median `0.048732`
