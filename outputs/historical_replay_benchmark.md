...
Generated at: `2026-09-11T08:20:12.955158+00:00`
...
- primary_mean_absolute_error: `0.019166`
- secondary_mean_absolute_error: `0.014693`
...
### base_path
- sample_size: `80`
- 3d: sample `80`, direction_hit `0.5875`, path_mae `0.015398`, as_primary `0`, as_primary_hit `None`, avg `0.000354`, median `0.003063`
...
### bounce_path
- sample_size: `80`
- 3d: sample `80`, direction_hit `0.5875`, path_mae `0.016678`, as_primary `0`, as_primary_hit `None`, avg `0.000354`, median `0.003063`
...
### failed_bounce_path
- sample_size: `80`
- 3d: sample `80`, direction_hit `0.4125`, path_mae `0.019166`, as_primary `80`, as_primary_hit `0.5875`, avg `0.000354`, median `0.003063`
...
### analog_average_path
- sample_size: `80`
- 3d: sample `80`, direction_hit `0.5875`, path_mae `0.014693`, as_primary `0`, as_primary_hit `None`, avg `0.000354`, median `0.003063`
...
### WEAK_EDGE
- sample_size: `80`
- 3d: sample `80`, primary_hit `0.4125`, primary_closer `0.325`, primary_mae `0.019166`, avg `0.000354`, median `0.003063`
...
- 3d: `{'predictor': 'downside_continuation_predictor', 'sample_size': 80, 'primary_hit_rate': 0.4125, 'primary_closer_than_secondary_rate': 0.325, 'primary_mean_absolute_error': 0.019166, 'selection_method': 'lowest primary path error, tie-broken by hit rate and primary-vs-secondary closeness'}`
...
- 3d: `{'sample_size': 80, 'sample_gate': 'moderate_evidence', 'primary_hit_rate': 0.4125, 'secondary_hit_rate': 0.5875, 'primary_vs_secondary_accuracy_spread': -0.175, 'primary_closer_than_secondary_rate': 0.325, 'best_scenario_type': {'scenario': 'analog_average_path', 'sample_size': 80, 'path_mean_absolute_error': 0.014693, 'direction_hit_rate': 0.5875}, 'worst_scenario_type': {'scenario': 'failed_bounce_path', 'sample_size': 80, 'path_mean_absolute_error': 0.019166, 'direction_hit_rate': 0.4125}, 'best_predictor': {'predictor': 'downside_continuation_predictor', 'sample_size': 80, 'primary_hit_rate': 0.4125, 'primary_closer_than_secondary_rate': 0.325, 'primary_mean_absolute_error': 0.019166, 'selection_method': 'lowest primary path error, tie-broken by hit rate and primary-vs-secondary closeness'}}`
...
### top_10
- sample_size: `8`
- 3d: sample `8`, primary_hit `0.375`, primary_closer `0.25`, primary_mae `0.025456`, avg `-0.001516`, median `0.004814`
...
### top_20
- sample_size: `16`
- 3d: sample `16`, primary_hit `0.4375`, primary_closer `0.25`, primary_mae `0.024327`, avg `-0.002364`, median `0.003063`
...
### bottom_20
- sample_size: `16`
- 3d: sample `16`, primary_hit `0.3125`, primary_closer `0.1875`, primary_mae `0.024543`, avg `0.003854`, median `0.007955`
