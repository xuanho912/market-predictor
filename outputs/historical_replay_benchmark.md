...
Generated at: `2026-09-03T05:52:50.125755+00:00`
...
- sample_size: `40`
- 3d: sample `40`, primary_hit `0.45`, primary_closer `0.4`, primary_mae `0.010663`, avg `-0.000361`, median `0.000609`
- 5d: sample `40`, primary_hit `0.4`, primary_closer `0.375`, primary_mae `0.017834`, avg `0.001792`, median `0.001271`
- 10d: sample `40`, primary_hit `0.625`, primary_closer `0.575`, primary_mae `0.034428`, avg `-0.005082`, median `-0.011016`
- 20d: sample `40`, primary_hit `0.4`, primary_closer `0.325`, primary_mae `0.084206`, avg `-0.001405`, median `0.009638`
- 60d: sample `40`, primary_hit `0.425`, primary_closer `0.4`, primary_mae `0.136639`, avg `0.007689`, median `0.031073`
...
- 3d: `{'predictor': 'downside_continuation_predictor', 'sample_size': 40, 'primary_hit_rate': 0.45, 'primary_closer_than_secondary_rate': 0.4, 'primary_mean_absolute_error': 0.010663, 'selection_method': 'lowest primary path error, tie-broken by hit rate and primary-vs-secondary closeness'}`
- 5d: `{'predictor': 'downside_continuation_predictor', 'sample_size': 40, 'primary_hit_rate': 0.4, 'primary_closer_than_secondary_rate': 0.375, 'primary_mean_absolute_error': 0.017834, 'selection_method': 'lowest primary path error, tie-broken by hit rate and primary-vs-secondary closeness'}`
- 10d: `{'predictor': 'trend_reversal_predictor', 'sample_size': 40, 'primary_hit_rate': 0.525, 'primary_closer_than_secondary_rate': 0.475, 'primary_mean_absolute_error': 0.02787, 'selection_method': 'lowest primary path error, tie-broken by hit rate and primary-vs-secondary closeness'}`
