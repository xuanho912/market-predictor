...
Generated at: `2026-09-08T06:02:15.214204+00:00`
...
- SPY: `blocked_by_global_gate` | primary `bearish_path` 0.375 | reason: Global trust gate is not ready.
- QQQ: `blocked_by_global_gate` | primary `bearish_path` 0.383 | reason: Global trust gate is not ready.
- IWM: `blocked_by_global_gate` | primary `bearish_path` 0.3367 | reason: Global trust gate is not ready.
- DIA: `blocked_by_global_gate` | primary `bearish_path` 0.3852 | reason: Global trust gate is not ready.
