...
Generated at: `2026-08-20T04:22:23.028882+00:00`
...
- SPY: `blocked_by_global_gate` | primary `bounce_path` 0.3204 | reason: Global trust gate is not ready.
- QQQ: `blocked_by_global_gate` | primary `bearish_path` 0.2992 | reason: Global trust gate is not ready.
- IWM: `blocked_by_global_gate` | primary `bounce_path` 0.3162 | reason: Global trust gate is not ready.
- DIA: `blocked_by_global_gate` | primary `bounce_path` 0.3294 | reason: Global trust gate is not ready.
