...
Generated at: `2026-09-22T01:27:00.769968+00:00`
...
- primary_vs_secondary: `{'status': 'forward_ready', 'by_horizon': {'3d': {'sample_size': 80, 'primary_hit_rate': 0.625, 'secondary_hit_rate': 0.65, 'primary_minus_secondary': -0.025, 'both_hit': 41, 'both_miss': 19}, '5d': {'sample_size': 80, 'primary_hit_rate': 0.6125, 'secondary_hit_rate': 0.6375, 'primary_minus_secondary': -0.025, 'both_hit': 40, 'both_miss': 20}, '10d': {'sample_size': 80, 'primary_hit_rate': 0.6125, 'secondary_hit_rate': 0.6125, 'primary_minus_secondary': 0.0, 'both_hit': 39, 'both_miss': 21}, '20d': {'sample_size': 80, 'primary_hit_rate': 0.7875, 'secondary_hit_rate': 0.7125, 'primary_minus_secondary': 0.075, 'both_hit': 50, 'both_miss': 10}, '60d': {'sample_size': 80, 'primary_hit_rate': 0.825, 'secondary_hit_rate': 0.7, 'primary_minus_secondary': 0.125, 'both_hit': 51, 'both_miss': 9}}, 'note': 'Forward sample gate has opened, but alpha status still requires stable performance over time.'}`
...
- sample_size: `40`
- 3d: sample `40`, hit `0.675`, avg `0.007607`, median `0.010897`, mae `0.016588`
- 5d: sample `40`, hit `0.625`, avg `0.00878`, median `0.013411`, mae `0.022615`
- 10d: sample `40`, hit `0.625`, avg `0.013632`, median `0.011619`, mae `0.031653`
- 20d: sample `40`, hit `0.8`, avg `0.036846`, median `0.033164`, mae `0.050976`
- 60d: sample `40`, hit `0.85`, avg `0.07332`, median `0.0765`, mae `0.080439`
...
- sample_size: `20`
- 3d: sample `20`, hit `0.45`, avg `-0.004311`, median `-0.0002`, mae `0.024211`
- 5d: sample `20`, hit `0.45`, avg `-0.006185`, median `-0.011157`, mae `0.027513`
- 10d: sample `20`, hit `0.5`, avg `-0.006789`, median `9.9e-05`, mae `0.044186`
- 20d: sample `20`, hit `0.65`, avg `0.007523`, median `0.017648`, mae `0.04141`
- 60d: sample `20`, hit `0.75`, avg `0.042411`, median `0.069875`, mae `0.085588`
...
- sample_size: `40`
- 3d: sample `40`, hit `0.725`, avg `0.012304`, median `0.018458`, mae `0.019937`
- 5d: sample `40`, hit `0.75`, avg `0.014899`, median `0.017411`, mae `0.025399`
- 10d: sample `40`, hit `0.675`, avg `0.022809`, median `0.024811`, mae `0.034861`
- 20d: sample `40`, hit `0.9`, avg `0.05093`, median `0.043456`, mae `0.055053`
- 60d: sample `40`, hit `0.85`, avg `0.081441`, median `0.090399`, mae `0.088111`
