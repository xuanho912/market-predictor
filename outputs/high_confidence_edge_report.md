...
Generated at: `2026-07-07T07:05:31.999798+00:00`
...
### MODERATE_EDGE
- sample_size: `40`
- 3d: sample `40`, hit `0.475`, avg `0.001634`, median `-0.000317`, mae `0.011395`
- 5d: sample `40`, hit `0.525`, avg `0.000266`, median `0.003026`, mae `0.015184`
- 10d: sample `40`, hit `0.6`, avg `0.007579`, median `0.003491`, mae `0.016201`
- 20d: sample `40`, hit `0.625`, avg `0.005152`, median `0.010788`, mae `0.02348`
- 60d: sample `40`, hit `0.45`, avg `0.000353`, median `-0.01711`, mae `0.053435`

### WEAK_EDGE
- sample_size: `20`
- 3d: sample `20`, hit `0.55`, avg `0.000928`, median `0.006632`, mae `0.01613`
- 5d: sample `20`, hit `0.5`, avg `0.0001`, median `0.004655`, mae `0.021657`
- 10d: sample `20`, hit `0.5`, avg `-0.002001`, median `0.003262`, mae `0.027434`
- 20d: sample `20`, hit `0.75`, avg `0.005479`, median `0.01128`, mae `0.025063`
- 60d: sample `20`, hit `0.45`, avg `-0.003405`, median `-0.001675`, mae `0.044831`
...
- primary_vs_secondary: `{'status': 'forward_pending', 'by_horizon': {'3d': {'sample_size': 80, 'primary_hit_rate': 0.4625, 'secondary_hit_rate': 0.4625, 'primary_minus_secondary': 0.0, 'both_hit': 37, 'both_miss': 43}, '5d': {'sample_size': 80, 'primary_hit_rate': 0.4625, 'secondary_hit_rate': 0.4625, 'primary_minus_secondary': 0.0, 'both_hit': 37, 'both_miss': 43}, '10d': {'sample_size': 80, 'primary_hit_rate': 0.4875, 'secondary_hit_rate': 0.4875, 'primary_minus_secondary': 0.0, 'both_hit': 39, 'both_miss': 41}, '20d': {'sample_size': 80, 'primary_hit_rate': 0.6875, 'secondary_hit_rate': 0.6875, 'primary_minus_secondary': 0.0, 'both_hit': 55, 'both_miss': 25}, '60d': {'sample_size': 80, 'primary_hit_rate': 0.5125, 'secondary_hit_rate': 0.5125, 'primary_minus_secondary': 0.0, 'both_hit': 41, 'both_miss': 39}}, 'note': 'Forward samples are still below the minimum gate; primary-vs-secondary remains a historical analog proxy.'}`
