...
Generated at: `2026-07-21T00:08:12.752512+00:00`

## Summary

- current_date: `2026-07-20`
- current_time_us_eastern: `2026-07-20T20:08:12.752512-04:00`
...
- warning_message: 核心行情已更新至最新应有交易日 2026-07-20。 部分辅助数据源使用缓存或存在 stale 标记，但核心 SPY/QQQ/IWM/DIA 行情已到最新应有交易日。
...
- BAA_SPREAD: status=`available`, latest_date=`2026-07-17`, source=`fred-api`, stale=`False`, fallback=`False`, real_data=`True`
- DFII10: status=`available`, latest_date=`2026-07-17`, source=`fred-api`, stale=`False`, fallback=`False`, real_data=`True`
