...
- warning_message: 当前仍处于美股盘中或收盘确认前，尚未形成完整收盘数据。 当前盘中快照日期为 2026-07-14，最近完整收盘交易日为 2026-07-14；正式 baseline_v1 预测记录应等美东 16:30 后重新生成。
...
- DIA: status=`available`, latest_date=`2026-07-14`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
...
- HYG: status=`available`, latest_date=`2026-07-14`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
...
- IWM: status=`available`, latest_date=`2026-07-14`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
- LQD: status=`available`, latest_date=`2026-07-14`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
- QQQ: status=`available`, latest_date=`2026-07-14`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
- RECESSION: status=`stale`, latest_date=`2026-06-01`, source=`fred-api`, stale=`True`, fallback=`False`, real_data=`True`
- RSP: status=`available`, latest_date=`2026-07-14`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- SPHB: status=`available`, latest_date=`2026-07-14`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- SPLV: status=`available`, latest_date=`2026-07-14`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- SPY: status=`available`, latest_date=`2026-07-14`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
- TLT: status=`available`, latest_date=`2026-07-14`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
- UUP: status=`available`, latest_date=`2026-07-14`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
- XLB: status=`available`, latest_date=`2026-07-14`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLC: status=`available`, latest_date=`2026-07-14`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLE: status=`available`, latest_date=`2026-07-14`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLF: status=`available`, latest_date=`2026-07-14`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLI: status=`available`, latest_date=`2026-07-14`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLK: status=`available`, latest_date=`2026-07-14`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLP: status=`available`, latest_date=`2026-07-14`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLRE: status=`available`, latest_date=`2026-07-14`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLU: status=`available`, latest_date=`2026-07-14`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
