...
Generated at: `2026-07-28T14:41:10.035685+00:00`

## Summary

- current_date: `2026-07-28`
- current_time_us_eastern: `2026-07-28T10:41:10.035685-04:00`
...
- last_successful_core_market_update: `2026-07-28`
- last_successful_update: `2026-07-28`
- warning_message: 当前仍处于美股盘中或收盘确认前，尚未形成完整收盘数据。 当前盘中快照日期为 2026-07-28，最近完整收盘交易日为 2026-07-27；正式 baseline_v1 预测记录应等美东 16:30 后重新生成。
...
- DIA: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
...
- HYG: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
...
- SPHB: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- SPLV: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- SPY: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
...
- XLU: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLV: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLY: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^SKEW: status=`available`, latest_date=`2026-07-27`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^TNX: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^VIX: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^VIX3M: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^VIX6M: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^VIX9D: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^VVIX: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- breadth_DIA: status=`available`, latest_date=`2026-07-27`, source=`static-dow30-list`, stale=`False`, fallback=`False`, real_data=`True`
- breadth_IWM: status=`proxy`, latest_date=`2026-07-28`, source=`iwm-spy-relative-strength-proxy`, stale=`False`, fallback=`True`, real_data=`False`
...
- flow_DIA: status=`proxy`, latest_date=`2026-07-28`, source=`market_data_proxy`, stale=`False`, fallback=`True`, real_data=`False`
- flow_IWM: status=`proxy`, latest_date=`2026-07-28`, source=`market_data_proxy`, stale=`False`, fallback=`True`, real_data=`False`
- flow_QQQ: status=`proxy`, latest_date=`2026-07-28`, source=`market_data_proxy`, stale=`False`, fallback=`True`, real_data=`False`
- flow_SPY: status=`proxy`, latest_date=`2026-07-28`, source=`market_data_proxy`, stale=`False`, fallback=`True`, real_data=`False`
- flow_provider: status=`proxy`, latest_date=`2026-07-28`, source=`flow_positioning_proxy`, stale=`False`, fallback=`True`, real_data=`False`
- macro_event_calendar: status=`fallback`, latest_date=`2026-07-28`, source=`deterministic_calendar_fallback`, stale=`False`, fallback=`True`, real_data=`False`
- news_event_provider: status=`available`, latest_date=`2026-07-28`, source=`finnhub+gdelt`, stale=`False`, fallback=`False`, real_data=`True`
- options_SKEW: status=`available`, latest_date=`2026-07-27`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- options_VIX: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- options_VIX3M: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- options_VIX6M: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- options_VIX9D: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- options_VVIX: status=`available`, latest_date=`2026-07-28`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
