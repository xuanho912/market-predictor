...
Generated at: `2026-09-16T16:59:36.032573+00:00`

## Summary

- current_date: `2026-09-16`
- current_time_us_eastern: `2026-09-16T12:59:36.032573-04:00`
...
- warning_message: 当前仍处于美股盘中或收盘确认前，尚未形成完整收盘数据。 当前盘中快照日期为 2026-09-16，最近完整收盘交易日为 2026-09-15；正式 baseline_v1 预测记录应等美东 16:30 后重新生成。
...
- DIA: status=`available`, latest_date=`2026-09-16`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
...
- HYG: status=`available`, latest_date=`2026-09-16`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
...
- IWM: status=`available`, latest_date=`2026-09-16`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- LQD: status=`available`, latest_date=`2026-09-16`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- QQQ: status=`available`, latest_date=`2026-09-16`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- RECESSION: status=`stale`, latest_date=`2026-08-01`, source=`fred-api`, stale=`True`, fallback=`False`, real_data=`True`
- RSP: status=`available`, latest_date=`2026-09-16`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- SPHB: status=`available`, latest_date=`2026-09-16`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- SPLV: status=`available`, latest_date=`2026-09-16`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- SPY: status=`available`, latest_date=`2026-09-16`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
