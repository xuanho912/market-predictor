...
Generated at: `2026-06-16T11:20:03.312621+00:00`

## Summary

- current_date: `2026-06-16`
- current_time_us_eastern: `2026-06-16T07:20:03.312621-04:00`
...
- warning_message: 核心行情已更新至最新应有交易日 2026-06-15。 部分辅助数据源存在 stale/cache 状态，但核心 SPY/QQQ/IWM/DIA 行情已到最新应有交易日。
...
- HYG: status=`available`, latest_date=`2026-06-15`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
...
- RSP: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- SPHB: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- SPLV: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- SPY: status=`available`, latest_date=`2026-06-15`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
- TLT: status=`available`, latest_date=`2026-06-15`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- UUP: status=`available`, latest_date=`2026-06-15`, source=`local-cache-finnhub-quote-patch`, stale=`False`, fallback=`True`, real_data=`True`
- XLB: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLC: status=`available`, latest_date=`2026-06-15`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLE: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLF: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLI: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLK: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLP: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLRE: status=`available`, latest_date=`2026-06-15`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLU: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLV: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
- XLY: status=`available`, latest_date=`2026-06-15`, source=`finnhub-quote-patch`, stale=`False`, fallback=`False`, real_data=`True`
...
- breadth_IWM: status=`proxy`, latest_date=`2026-06-15`, source=`iwm-spy-relative-strength-proxy`, stale=`False`, fallback=`True`, real_data=`False`
...
- flow_DIA: status=`proxy`, latest_date=`2026-06-15`, source=`market_data_proxy`, stale=`False`, fallback=`True`, real_data=`False`
- flow_IWM: status=`proxy`, latest_date=`2026-06-15`, source=`market_data_proxy`, stale=`False`, fallback=`True`, real_data=`False`
- flow_QQQ: status=`proxy`, latest_date=`2026-06-15`, source=`market_data_proxy`, stale=`False`, fallback=`True`, real_data=`False`
