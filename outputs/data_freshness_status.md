...
Generated at: `2026-08-12T23:28:46.780867+00:00`

## Summary

- current_date: `2026-08-12`
- current_time_us_eastern: `2026-08-12T19:28:46.780867-04:00`
...
- RSP: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- SPHB: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- SPLV: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- SPY: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- TLT: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- UUP: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLB: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLC: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLE: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLF: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLI: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLK: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLP: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLRE: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLU: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLV: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- XLY: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^SKEW: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^TNX: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^VIX: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^VIX3M: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^VIX6M: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^VIX9D: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- ^VVIX: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- breadth_DIA: status=`available`, latest_date=`2026-08-10`, source=`static-dow30-list`, stale=`False`, fallback=`False`, real_data=`True`
- breadth_IWM: status=`proxy`, latest_date=`2026-08-12`, source=`iwm-spy-relative-strength-proxy`, stale=`False`, fallback=`True`, real_data=`False`
...
- flow_QQQ: status=`proxy`, latest_date=`2026-08-12`, source=`market_data_proxy`, stale=`False`, fallback=`True`, real_data=`False`
- flow_SPY: status=`proxy`, latest_date=`2026-08-12`, source=`market_data_proxy`, stale=`False`, fallback=`True`, real_data=`False`
- flow_provider: status=`proxy`, latest_date=`2026-08-12`, source=`flow_positioning_proxy`, stale=`False`, fallback=`True`, real_data=`False`
- macro_event_calendar: status=`fallback`, latest_date=`2026-08-12`, source=`deterministic_calendar_fallback`, stale=`False`, fallback=`True`, real_data=`False`
- news_event_provider: status=`available`, latest_date=`2026-08-12`, source=`finnhub+gdelt`, stale=`False`, fallback=`False`, real_data=`True`
- options_SKEW: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- options_VIX: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- options_VIX3M: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- options_VIX6M: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- options_VIX9D: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
- options_VVIX: status=`available`, latest_date=`2026-08-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
