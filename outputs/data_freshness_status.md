...
Generated at: `2026-06-16T07:29:12.821852+00:00`

## Summary

- current_date: `2026-06-16`
- current_time_us_eastern: `2026-06-16T03:29:12.821852-04:00`
...
- warning_message: 数据已过期，当前预测不可作为今日判断。 最新核心行情日期为 2026-06-12，按美股交易日应至少更新到 2026-06-15。
...
- ^VIX: status=`available`, latest_date=`2026-06-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
...
- options_VIX: status=`available`, latest_date=`2026-06-12`, source=`yahoo-chart`, stale=`False`, fallback=`False`, real_data=`True`
