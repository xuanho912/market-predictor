...
Generated at: `2026-07-06T15:57:44.931390+00:00`

This report reviews forecast-vs-actual deviations after horizons complete. It is not a trading, PnL or execution report.

## Summary

- total_forecast_records: `60`
- raw_forecast_rows: `60`
- deduped_legacy_rows: `0`
- completed_outcomes_reviewed: `164`
- material_deviation_count: `74`
- latest_forecast_date: `2026-07-02`
- latest_reviewed_forecast_date: `2026-07-01`
...
- `news_data_gap_limited_attribution` count `74`: 新闻数据缺口会限制归因质量，需要标记而不是事后编故事。 Action: keep_observing_until_forward_sample_gate
- `intraday_snapshot_risk` count `74`: 盘中快照未确认时，不应冻结为正式收盘预测。 Action: keep_observing_until_forward_sample_gate
