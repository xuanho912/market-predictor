...
Generated at: `2026-08-15T04:11:20.704007+00:00`
...
- update_blockers: `[{'reason': 'no_future_market_close_yet', 'detail': 'Latest market date 2026-08-14 is not after latest forecast date 2026-08-14, so no completed 1d/3d/5d outcome can be scored yet.'}]`
...
- `news_event_risk_underweighted` count `156`: 风险新闻如果被价格确认，应提高风险路径权重。 Action: shadow-test risk_event_confirmation：risk-off 新闻得到价格确认才提高风险路径。
